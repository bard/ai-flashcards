...
test("construct question/answer pair from extended service description", async () => {
  ...
  expect(qaPair).toMatchInlineSnapshot(`
    {
      "answer": "Transform pet photos into artistic styles resembling disney-pixar animation, Provide a variety of styles for personalizing pet images, Facilitate the creation of personalized gifts from pet images
    <a href="https://sketch2photo.ai" target="_blank">Sketch2Photo AI</a> Turn you pet photos into cool disney-pixar animation like art or choose from many other styles. Then easily turn these images into personalised gifts for you, your friends or loved ones!",
      "question": "A service operates in the fields of Pet imagery, Digital Art, Personalized Gift Creation. It uses these AI-based methods: Image style transfer using neural networks, AI-based image processing for style conversion. What goals do you think it is pursuing?",
    }
  `);
});
